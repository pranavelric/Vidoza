        ...
        if (type != null) {
            if (type.equals(Constants.REMOTE_MSG_INVITATION)) {
                ...
                Intent(applicationContext, IncomingMeetingActivity::class.java).also {
                    ...
                    it.putExtra(Constants.REMOTE_MSG_MEETING_TYPE,remoteMessage.data.get(Constants.REMOTE_MSG_MEETING_TYPE))
                    it.putExtra(Constants.USER_IMAGE_URL,remoteMessage.data.get(Constants.USER_IMAGE_URL))
                    ...
                    it.putExtra(Constants.USER_PHONE_NUMBER,remoteMessage.data.get(Constants.USER_PHONE_NUMBER))
